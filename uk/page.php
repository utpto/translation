...
return [
    ...
    'aboutus-advantage1'    => 'UTOPIA - це приватний торрент трекер нового покоління з чудовим візуальним оформленням і прогресивним функціоналом.',
    'aboutus-advantage2'    => 'UTOPIA створено з метою поширення і полуляризації <em>україномовного контенту</em>. Тому кожний фільм чи серіал, який є на сайті має <em>українське озвучення</em>.',
    ...
    'aboutus-advantage4'    => 'UTOPIA немає відкритої реєстрації, кожний учасник спільноти був ретельно відібраний і запрошений іншим учасником. Це дозволяє нам сформувати спільноту однодумців, тих людей, яким можна довіряти, і які об\'єднані однією ідеєю.',
    ...
    'aboutus-welcome-desc'  => 'UTOPIA – це створена <em>спільнотою</em> база даних фільмів/серіалів. Всі дані були додані нашими чудовими учасниками. Основний фокус UTOPIA зосереджено на HD+ контенті, розвитку проактивної спільноти та якісному сервісі.',
